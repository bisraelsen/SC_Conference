...
\begin{figure}[tbp]
    ...
    \caption{Example screenshot from the Amazon Mechanical Turk experiment. \nisar{details after his sentence should be moved to main text:} In this image both \xQ{} and \xP{} are displayed, indicating that the user is in condition 4. Other conditions have identical layout but with the values for \xQ{} and/or \xP{} missing according to the experiment design. } 
