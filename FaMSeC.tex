...
\brett{Add a couple paragraphs here about \xP.
Here we need to talk about \xP{} and show the equations(?) for UPM/LPM. Also, give a quick word or two about how the metric can be intuitively understood.}
...
=======
    \brett{I have now started thinking about \xP{} being the \emph{shape} of the distribution, and \xQ{} referring to the location of the distribution wrt the trusted \solvestar{}}
>>>>>>> 8dde660e4cb24b0b68cb9016a0d58ec005e12fa9
